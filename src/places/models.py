...
class Place(models.Model):
    ...
    short_description = models.TextField('Краткое описание', max_length=300, null=False, blank=True)
    long_description = HTMLField('Подробное описание', null=False, blank=True)
